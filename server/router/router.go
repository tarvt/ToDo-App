...
func Router() mux.Router {
	...
	router.HandleFunc("/api/deleteTask/{id}", middleware.DeleteTask).Methods("PUT", "OPTIONS")
	router.HandleFunc("/api/deleteAllTasks", middleware.DeleteAllTasks).Methods("PUT", "OPTIONS")
